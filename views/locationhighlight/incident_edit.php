<div class="row" style="border: 2px solid gray; padding: 10px; width:340px; margin:auto; margin-top:10px; margin-bottom:10px;" >
	...
	<span style="float:right;"><a href="#" onclick="clearMap(1); $('#adminarea_level_1').html(''); return false;"><?php echo Kohana::lang('layer.clear');?></a></span>
	<h4><?php echo Kohana::lang('layer.select');?><?php echo $level_name; ?>:
	</h4>
	...
	<a href="#" onclick="switchArea(1);  return false;"><?php echo Kohana::lang('layer.update');?></a> <span id="admin_area_loading_1"></span>
